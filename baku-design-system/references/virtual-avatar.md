...
Baku 是一个工作台型个人 IP：安静、可靠、能把复杂问题拆成可验证步骤。头像应传达“工作台、判断、执行”，而不是可爱吉祥物或未来感机器人。
...
```text
一张方形个人 IP 头像，东亚男性，中长蓬松黑发，圆框眼镜，黑色 T 恤，坐在电脑前，黄色背景，蓝色电脑，旁边有小植物、咖啡杯、笔记本和便签线索，手绘铅笔质感，温暖但克制，平静专注的表情，可以轻轻挥手，像真实个人品牌头像，不幼稚，不赛博朋克，不要重度二次元风格，不使用霓虹光效，不使用蓝紫渐变。
```
