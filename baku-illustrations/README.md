...
它借鉴了参考仓库的组织方式：`SKILL.md` 控制工作流，`references/` 拆出风格、角色、构图、prompt 和 QA，`assets/` 放校准素材。但它不是参考仓库换皮；核心已经换成 Baku 自己的个人 IP、暖纸工作台、克制手绘线条和工程证据链气质。
...
- 在图里使用 Baku 个人 IP 承担核心动作，而不是只做装饰头像。
...
- Baku 个人 IP：圆框眼镜、中长黑发、黑 T、电脑和笔记工作台。
